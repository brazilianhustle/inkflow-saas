...
#
# Hook SessionStart: re-injeta o estado vivo da frente atendimento-premium
# depois de limpar/compactar o contexto, para o loop sobreviver sem sair da aba.
#
# Adaptado a realidade do Claude Code:
#   - dispara so em clear/compact/resume (momentos em que o contexto morre),
#     NUNCA em startup, para nao poluir outras frentes do repo;
