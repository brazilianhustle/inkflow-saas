// ── §3 FLUXO Exato — extraido de generate-prompt.js linhas 167-281 ──────────
// MVP: bit-a-bit identico ao Faixa (copia bit-a-bit). O branching
// `valor_tipo === "faixa"` no §3.3 e DEAD CODE intencional aqui (Exato tenants
// sempre recebem valor_tipo === "exato" da tool calcular_orcamento) — mantido
// pra preservar texto exato do snapshot baseline. Limpeza do dead branch fica
// explicita pra PR futuro de simplificacao (NAO incluir em PR 1/2/3 do Modo Coleta).
