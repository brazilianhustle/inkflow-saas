// ── Generator — modo Coleta v2, fase TATTOO ────────────────────────────────
// Compoe os blocos do prompt da fase de coleta da tattoo. Mesma ordem
// arquitetural do gerador Exato (identidade, checklist, tom, fluxo, regras,
// contexto, faq, fewshots tenant, fewshots base). Diferenca esta nos blocos
// fluxo/regras/few-shot/few-shot-tenant — todos especificos da fase.
