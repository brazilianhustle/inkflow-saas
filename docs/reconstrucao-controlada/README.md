...
Proxima decisao: decisao humana de Stage. Opcoes seguras: manter bloqueado, aprovar apenas Supabase staging, aprovar apenas Provider staging, aprovar apenas SaaS runtime staging ou aprovar execucao Stage ordenada com checkpoints explicitos. Nao executar staging, adapter real de WhatsApp/Supabase remoto/Telegram, migration real, deploy ou secrets sem aprovacao explicita.
