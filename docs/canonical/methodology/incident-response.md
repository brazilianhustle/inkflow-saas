...
- **billing-flow** ✅ em prod 2026-04-29 (PR #N — atualizar com número real após Task 9): detecta problemas no fluxo de pagamento — webhook delay/silence, MailerLite drift e inconsistências de DB. Alerta `[critical] [billing-flow]` → seguir [mp-webhook-down.md](../runbooks/mp-webhook-down.md). Doc canônico: [auditores.md#billing-flow](../auditores.md#billing-flow).
